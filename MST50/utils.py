...
def load_config(sheet_name='config', strategies_run_modes=['live']):
    ...
    for _, row in df.iterrows():
        ...
        strategy_config = {
            ...
            'indicators': {
                f'indicator_{i}': {
                    'indicator_name': row[f'indicator_{i}'],
                    'indicator_use': row[f'indicator_{i}_use'],
                    'indicator_params': {
                        'a': row[f'indicator_{i}_param_a'],
                        'b': row[f'indicator_{i}_param_b'],
                        'c': row[f'indicator_{i}_param_c'],
                        'd': row[f'indicator_{i}_param_d'],
                        'e': row[f'indicator_{i}_param_e'],
                        'f': row[f'indicator_{i}_param_f'],
                        'g': row[f'indicator_{i}_param_g'],
                        'h': row[f'indicator_{i}_param_h'],
                        'i': row[f'indicator_{i}_param_i'],
                        'j': row[f'indicator_{i}_param_j'],
                        'k': row[f'indicator_{i}_param_k'],
                    },
                } for i in range(1, 4)
            },
            'exit_params': {
