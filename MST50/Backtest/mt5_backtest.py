...
- Data is now stored in Parquet format for faster loading.
- Data is loaded as NumPy arrays instead of Pandas DataFrames for efficiency.
- Optimized critical functions like `copy_rates_from_pos`, `get_current_price`, and `simulate_target_hit_close`.
- Implemented caching where appropriate to avoid redundant computations.
- Adjusted data types to reduce memory usage and improve speed.
- Avoided unnecessary data copies by using views and in-place operations.
